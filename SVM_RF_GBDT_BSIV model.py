...
plt.xlim([0, 1.05])
plt.ylim([0, 1.05])
plt.plot(fpr1, tpr1, linestyle='-', label='BSIV+SVM(AUC=%0.3f)' %test_auc1, color='b')
plt.plot(fpr2, tpr2, linestyle='-', label='BSIV+RF(AUC=%0.3f)' %test_auc2, color='g')
plt.plot(fpr3, tpr3, linestyle='-', label='BSIV+GBDT(AUC=%0.3f)' %test_auc3, color='r')
