...
# plt.xlim([0, 1.05])
# plt.ylim([0, 1.05])
# plt.plot(fpr1, tpr1, linestyle='-', label='Slope+SVM(AUC=%0.3f)' %test_auc1, color='b')
# plt.plot(fpr2, tpr2, linestyle='-', label='Slope+RF(AUC=%0.3f)' %test_auc2, color='g')
# plt.plot(fpr3, tpr3, linestyle='-', label='Slope+GBDT(AUC=%0.3f)' %test_auc3, color='r')
# plt.xlabel('False positive rate',fontsize=12)
# plt.ylabel('True positive rate',fontsize=12)
# plt.text(0.8, 0.4,'(c)',fontsize=14)
...
Slope_SVM_result = './Slope_SVM_result.txt'
#saveResults(GeoID, y_pred1, y_pred_proba1, Slope_SVM_result)
saveResults(GeoID, y_pred_proba1, Slope_SVM_result)

y_pred_proba2 = model2.predict_proba(X)[:,1]
Slope_RF_result = './Slope_RF_result.txt'
saveResults(GeoID, y_pred_proba2, Slope_RF_result)

y_pred_proba3 = model3.predict_proba(X)[:,1]
Slope_GBDT_result = './Slope_GBDT_result.txt'
saveResults(GeoID, y_pred_proba3, Slope_GBDT_result)